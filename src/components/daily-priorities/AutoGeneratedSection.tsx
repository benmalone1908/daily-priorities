            ...
            <table className="w-full caption-bottom text-xs">
              <thead>
                <tr className="border-b sticky top-0 bg-white dark:bg-slate-950 z-10 shadow-sm">
                  ...
                  {!showPacingColumns && (
                    <th className="h-10 px-2 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px] w-40 whitespace-nowrap bg-white dark:bg-slate-950">
